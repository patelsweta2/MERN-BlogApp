...
const PostPage = () => {
  ...
  return (
    <main className="mt-[80px] p-3 flex flex-col max-w-6xl mx-auto min-h-screen">
      <ProgressBar />
      ...
      <div
        className="p-3 max-w-2xl mx-auto w-full overflow-hidden overflow-ellipsis text-justify break-words"
